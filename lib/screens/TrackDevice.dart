...
class _TrackDeviceState extends State<TrackDevicePage> {
  ...
  void updateMarker(PositionModel pos) async {
    ...
    if (pos.attributes!.containsKey("idleDuration")) {
      idleDurationValue = pos.attributes!["idleDuration"].toString();
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: GetX<DataController>(
            init: DataController(),
            builder: (controller) {
              return !controller.isLoading.value ? buildMap(controller) : CircularProgressIndicator();
            }));
  }
